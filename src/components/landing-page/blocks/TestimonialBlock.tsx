...
export function TestimonialBlock({ block }: { block: Block }) {
  ...
  return (
    <div style={{ padding: `${spacing[20] + 8}px ${spacing[16]}px`, textAlign: 'center', background: colors.gray100 }}>
      <div style={{ maxWidth: 720, margin: '0 auto' }}>
        <div style={{ fontSize: 64, lineHeight: 0.5, color: colors.success, marginBottom: spacing[2] }}>❝</div>
        <p style={{
          fontFamily: font.heading, fontWeight: fontWeight.heading, fontSize: 34,
        ...
        <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'center', gap: spacing[3] }}>
          ...
          <div style={{ textAlign: 'left' }}>
            <div style={{ fontWeight: fontWeight.bold, fontSize: fontSize.body, color: colors.ink }}>{d.name}</div>
            <div style={{
