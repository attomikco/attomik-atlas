...
import { LayoutGrid, Users, Mail, Sparkles, Settings, Target, FileCode } from 'lucide-react'
...
export default function Sidebar() {
  ...
  return (
    <aside style={{ width: 260, background: '#000', flexShrink: 0 }} className="flex flex-col h-screen">
      {/* Logo */}
