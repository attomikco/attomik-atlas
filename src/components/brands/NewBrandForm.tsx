    ...
    <div className="card bg-paper border border-border rounded-card p-6 space-y-5">
      <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
        <div className="form-group">
          <label className="form-label label block mb-1.5">Brand name *</label>
        ...
        <div className="form-group">
          <label className="form-label label block mb-1.5">Slug *</label>
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
        <div className="form-group">
          <label className="form-label label block mb-1.5">Website</label>
          <input className={inputCls} value={form.website} placeholder="https://brand.com"
            onChange={e => setForm(f => ({ ...f, website: e.target.value }))} />
        </div>
        <div className="form-group">
          <label className="form-label label block mb-1.5">Product category</label>
      ...
      <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
        <div className="form-group">
          <label className="form-label label block mb-1.5">Primary color</label>
        ...
        <div className="form-group col-span-2">
          <label className="form-label label block mb-1.5">Tone keywords</label>
      ...
      <div className="form-group">
        <label className="form-label label block mb-1.5">Brand voice (optional — can add later)</label>
      ...
      <button onClick={submit} disabled={saving}
        className="btn btn-primary flex items-center gap-2 text-sm font-bold px-6 py-2.5 rounded-btn transition-opacity hover:opacity-90 disabled:opacity-50"
      >
